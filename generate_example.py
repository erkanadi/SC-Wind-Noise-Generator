...
GUSTINESS = 5 # Number of speed points. One yields constant wind. High values yield gusty wind (more than 10 can sound unnatural).
...
WIND_PROFILE_OUTDOOR = np.array([ 8.05 , 10.05 , 8.05 , 7.45, 4.32]) # Wind speed data example
...
# Save signal in .wav file
wn.save_signal(wn_signal, filename='./wind_noise_12.wav', num_ch=1, fs=16000)
# Plot signal
